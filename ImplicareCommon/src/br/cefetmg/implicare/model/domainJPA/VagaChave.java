...
public class VagaChave {
    ...
    @Column(name="Desc_Vaga", nullable = false)
    ...
    public VagaChave(long CNPJ, int Cod_Cargo, Date Dat_Publicacao, int Num_Vagas, int Carga_Horaria, double Remuneracao, String Desc_Vaga, int Status_Vaga){
        this.CNPJ = CNPJ;
